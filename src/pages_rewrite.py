import os
PAGES = ['calculators/morby-stack','calculators/echo','calculators/dscr','calculators','affiliates','about','faq','privacy','terms','stack','echo','double-close','emd','hard-money','dscr']
def rewrite(fp, up):
    h = open(fp).read()
    for p in PAGES:
