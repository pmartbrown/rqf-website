...
<div class="vlb" role="button" tabindex="0" aria-label="Play video: The Stack Method explained" onclick="openVideo('DraFEklqpTU')" onkeydown="if(event.key==='Enter')openVideo('DraFEklqpTU')">
  <img src="https://i.ytimg.com/vi/DraFEklqpTU/hqdefault.jpg" alt="The Stack Method explained" loading="lazy">
  <div class="vplay"></div>
