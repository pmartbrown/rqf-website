...
<div class="calcwrap">
  <div class="calc"><div style="font-family:var(--disp);font-weight:800;text-transform:uppercase;letter-spacing:.08em;font-size:11px;color:var(--mut);margin-bottom:10px">Stack Method</div>
    ...
    <div class="cgrid">
      ...
      <div class="fld"><label>Seller carry <span class="hint" id="s_sc_d"></span></label><div class="inwrap"><input class="pctin" id="s_scp" value="29.54" oninput="fmtp(this);stack()"><span class="sfx">%</span></div></div>
